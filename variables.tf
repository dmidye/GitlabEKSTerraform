...
variable "availability_zones" {
  ...
  description = "Availability zones to house subnets"
}
...
variable "vpc_id" {
  type        = string
  default     = "vpc-0c8f96fc0f6ed53b2"
  description = "VPC ID for the EKS cluster"
}

variable "subnet_ids" {
  description = "A list of subnet IDs to launch the cluster in"
  default     = ["subnet-0073fdc578c8421eb", "subnet-04925cb3aa035bf96", "subnet-0d04a93f0fcfcb3f0"]
  type        = list(string)
}
...
# not totally sure what this does but it's required and worked with 'test'
